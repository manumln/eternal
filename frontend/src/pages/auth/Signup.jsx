...
const SignupForm = () => {
  ...
  const onSubmit = async (values) => {
    setIsLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_BACKEND_URL}/users/signup`, values);
  ...
  const renderPasswordField = (id, label, placeholder, isPasswordVisible, toggleVisibility) => (
    <div className="relative">
      <Input
        ...
        clearable
        bordered
        contentLeft={<FiLock className="text-gray-400" />}
        contentRight={
          <button
            type="button"
  ...
  const buttonClasses = "bg-gradient-to-r from-blue-500 to-green-500 text-white hover:opacity-90 transition-opacity shadow-lg";
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full">
            ...
            <Button
              ...
              size="lg"
            >
              {isLoading ? <Spinner className="animate-spin" /> : "Create Account"}
            </Button>
